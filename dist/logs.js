...
export default async function createLoggerModule(projectName) {
...
Log Levels:
    ...
    await logFile.append(heading)
    log(heading)

    const logger = {
        warn: async (message, timestamp = Date.now()) => {
        ...
        error: async (message, timestamp = Date.now()) => {
        ...
        info: async (message, timestamp = Date.now()) => {
        ...
        log: async (message, timestamp = Date.now()) => {
